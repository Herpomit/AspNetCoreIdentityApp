...
namespace AspNetCoreIdentityApp.Web.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public MemberController(SignInManager<AppUser> singManager, UserManager<AppUser> userManager, IFileProvider fileProvider)
        {
        ...
        public async Task<IActionResult> PasswordChange(PasswordChangeViewModel request)
        {
            ...
            TempData["SuccessMessage"] = "Şifreniz Başarı ile değişmiştir.";
